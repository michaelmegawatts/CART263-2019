...
function flyDropped (event,ui) {
  let elementDropped = ui.draggable[0].id;
  console.log(elementDropped);
  if (elementDropped=== "fly") {
...
// Allows the goldpoo to be dragged, returned to its spot, and play
// disgust sound effect
$( function() {
  $( "#goldpoo" ).draggable({ revert: "valid",
  start: function (){
    grossSFX.play();
  }
});
